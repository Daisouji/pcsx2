...
bool GSDeviceNull::ChangeWindow(const WindowInfo& new_wi)
{
    return true;
}
...
bool GSDeviceNull::IsExclusiveFullscreen()
{
    return true;
}
bool GSDeviceNull::SetExclusiveFullscreen(bool fullscreen, u32 width, u32 height, float refresh_rate)
{
    return true;
}
